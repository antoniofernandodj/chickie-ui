      ...
      <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
          ...
          <div class="text-center mb-8">
            ...
            <p class="text-gray-500 text-sm mt-1">Entre na sua conta Chickie</p>
          </div>

          <!-- Form -->
          <form (ngSubmit)="submit()" #f="ngForm" novalidate class="space-y-5">
            <div>
              ...
              <input
                ...
                class="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm outline-none transition-all
                       focus:border-orange-400 focus:ring-2 focus:ring-orange-100 placeholder-gray-400"
              />
            </div>
            <div>
              ...
              <div class="relative">
                <input
                  ...
                  placeholder="••••••••"
                  class="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm outline-none transition-all
                         focus:border-orange-400 focus:ring-2 focus:ring-orange-100 placeholder-gray-400 pr-12"
                />
                <button type="button"
          ...
          <p class="text-center text-sm text-gray-500 mt-6">
            Não tem conta?
            <a routerLink="/auth/signup" class="font-semibold hover:underline" style="color:var(--color-brand)">
              Criar conta
            </a>
          </p>
        </div>
